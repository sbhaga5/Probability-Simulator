...
FileName <- "Return and Correlation Data STRS.xlsx"
NumberofYears <- 20
...
ggsave("Return Distribution.png", width = 6, height = 4, dpi = 800)  
...
write_excel_csv(as.data.frame(SimulationData), 'Simulation Data.csv')
